...
void Lab8::Update(float deltaTimeSeconds) {
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(1.7f,0.7f, 8.3f));
    }

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(1.54f, 15.0f, 0.46f));
    }

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.1f, 0.75f, 3.4f));
    }
...
void Lab8::OnInputUpdate(float deltaTime, int mods) {
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT)) {
        ...
        turn = glm::rotate(turn, angleOY, glm::vec3(0, 0, 1));
